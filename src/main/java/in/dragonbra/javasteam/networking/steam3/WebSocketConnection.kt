...
class WebSocketConnection : Connection(), WebSocketCMClient.WSListener {
    ...
    override fun getLocalIP(): InetAddress {
        return client.get()!!.localSocketAddress!!.address
    }

    override fun getCurrentEndPoint(): InetSocketAddress {
        return socketEndPoint!!
    }

    override fun getProtocolTypes(): ProtocolTypes {
    ...
    companion object {
        ...
        private fun getUri(address: InetSocketAddress): URI {
            return URI.create("wss://" + address.hostString + ":" + address.port + "/cmsocket/")
        }
    }
}
