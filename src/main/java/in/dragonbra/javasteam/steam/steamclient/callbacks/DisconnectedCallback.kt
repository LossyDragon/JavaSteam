 ...
 *
 * @constructor This callback is received when the steamclient is physically disconnected from the Steam network.
 * @param isUserInitiated If true, the disconnection was initiated by calling [CMClient.disconnect].
