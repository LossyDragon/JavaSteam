 ...
 *
 * @constructor Initializes a new instance of the [LogOnDetails] class.
 ...
 *  @see [accountInstance]
 * @param isRequestSteam2Ticket Gets or sets a value indicating whether to request the Steam2 ticket.
...
data class LogOnDetails(
    ...
    var isShouldRememberPassword: Boolean = false,
    var accessToken: String? = null,
    var accountInstance: Long = SteamID.DESKTOP_INSTANCE,
    var accountID: Long = 0L,
    var isRequestSteam2Ticket: Boolean = false,
