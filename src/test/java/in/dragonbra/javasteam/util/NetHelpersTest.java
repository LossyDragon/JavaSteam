...
public class NetHelpersTest extends TestBase {
    ...
    public void getIPAddressAsInt() throws UnknownHostException {
        Assertions.assertEquals(2130706433, NetHelpers.getIPAddressAsLong(loopbackV4));
        Assertions.assertEquals(1, NetHelpers.getIPAddressAsLong(InetAddress.getByName("0.0.0.1")));
        Assertions.assertEquals(0xFFFFFFFFL, NetHelpers.getIPAddressAsLong(InetAddress.getByName("255.255.255.255")));
        Assertions.assertEquals(3232235521L, NetHelpers.getIPAddressAsLong(InetAddress.getByName("192.168.0.1")));
        Assertions.assertEquals(167772161, NetHelpers.getIPAddressAsLong(InetAddress.getByName("10.0.0.1")));
        Assertions.assertEquals(2886729729L, NetHelpers.getIPAddressAsLong(InetAddress.getByName("172.16.0.1")));
    }
    ...
    public void fail_getIPAddressAsLong_If_V6() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> NetHelpers.getIPAddressAsLong(loopbackV6));
    }
