...
public class CollectionsTest {
    ...
    @Test
    public void getKeyByValueCompatExistingValue() {
        var result = CollectionUtils.getKeyByValueCompat(values, "A Value");
        Assertions.assertEquals(2, result);
    }

    @Test
    public void getKeyByValueCompatNullValue() {
        var nullResult = CollectionUtils.getKeyByValueCompat(values, "Null Value");
        Assertions.assertNull(nullResult);

        var nullResult2 = CollectionUtils.getKeyByValueCompat(values, null);
        Assertions.assertNull(nullResult2);
    }
}
